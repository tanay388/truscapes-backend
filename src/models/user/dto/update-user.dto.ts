...
export class UpdateUserDto {
  ...
  @ApiPropertyOptional({
    description: "User's additional details",
  ...
  @ApiPropertyOptional({
    description: "User's billing city",
  ...
  @ApiPropertyOptional({
    description: "User's billing state",
  ...
  @ApiPropertyOptional({
    description: "User's billing zip code",
    example: '12345',
  })
  @IsString()
  @IsOptional()
